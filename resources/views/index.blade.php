...
<body id="page-top">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Periode
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
    ...
    <scri src="vendor/bootstrap/js/bootstrap.bundle.min.js">
        </script>
        ...
        <!-- Page level plugins -->
        <scri src="vendor/chart.js/Chart.min.js">
            </script>
